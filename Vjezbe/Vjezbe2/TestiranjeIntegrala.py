...
plt.scatter(n_lista,pravokutnik_min, label="Donja međa")
plt.scatter(n_lista,pravokutnik_max, label="Gornja međa")

#Rješenje integrala x**2 je x**3/3 s uvrštenim vrijednostima(10**3/3-2**3/3)

plt.scatter(np_n, (10**3/3-2**3/3)*np_n**0 , label="Analitička vrijednost")
plt.xlabel("Broj podjela intervala n")
plt.ylabel("Vrijednost integrala na datom rasponu vrijednosti (2-->10)")
plt.scatter(n_lista, trapez_povrsina, label="Trapezna metoda")
plt.legend()
plt.show()
