...
print("Tri sigme redom(za veliki broj mjerenja) (sigma cijele populacije, sigma uzorka, sigma medijana) su: "+str(sigme_3(veliko_n)))
print("Tri sigme redom(za mali broj mjerenja) (sigma cijele populacije, sigma uzorka, sigma medijana) su: "+str(sigme_3(malo_n)))
...
print("sigma_medijana za veliko_n je: "+f"{sigme_3(veliko_n)[2]}")
print("sigma_medijana za malo_n je: "+f"{sigme_3(malo_n)[2]}")
#Sigma medijana je izrazito manja za veliki broj mjerenja